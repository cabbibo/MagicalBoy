function Mountains( params ){
  ...
  for( var i = 0; i < p.numOf; i++ ){
    ...
    var mRadius = p.radius + p.radius * p.randRadius * seed;
    ...
    for( var j = 0; j < p.detail; j++ ){
      for( var k = 0; k < p.detail; k++ ){
        ...
        positions[ fIndex + 0 ] = v1.x;
        positions[ fIndex + 1 ] = v1.y;
        positions[ fIndex + 2 ] = v1.z;

        positions[ fIndex + 3 ] = v2.x;
        positions[ fIndex + 4 ] = v2.y;
        positions[ fIndex + 5 ] = v2.z;
        
        positions[ fIndex + 6 ] = v3.x;
        positions[ fIndex + 7 ] = v3.y;
        positions[ fIndex + 8 ] = v3.z;

        positions[ fIndex + 9 ]   = v3.x;
        positions[ fIndex + 10 ]  = v3.y;
        positions[ fIndex + 11 ]  = v3.z;

        positions[ fIndex + 12 ]  = v2.x;
        positions[ fIndex + 13 ]  = v2.y;
        positions[ fIndex + 14 ]  = v2.z;

        positions[ fIndex + 15 ]  = v4.x;
        positions[ fIndex + 16 ]  = v4.y;
        positions[ fIndex + 17 ]  = v4.z;
